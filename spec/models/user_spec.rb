...
RSpec.describe User, type: :model do
  ...
  context 'associations' do
    ...
    # it 'has many logging_user_actions' do
    #   expect(user).to respond_to :logging_user_actions
    #   expect(user.logging_user_actions.to_a).to eq []
    #   action = user.logging_user_actions.create!()
    #   expect(user.reload.comments).to eq [action]
    # end
